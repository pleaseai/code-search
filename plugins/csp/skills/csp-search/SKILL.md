---
name: csp-search
description: Search any codebase by intent or symbol with csp instead of grep. Use for finding code by what it does, locating implementations, understanding how something works, or discovering related code.
---
